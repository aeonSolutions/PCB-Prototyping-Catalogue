...
**1 PCB design privatly available** (subscription users)
...
- Subscribe to the repository with the specific PCB you want (one time subscription fee to sponsor my open hardware work dedication and fairness of work). Download the Gerber files and order fabrication & components assembly on your favority PCB factory.
