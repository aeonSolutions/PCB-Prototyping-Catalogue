...
This is the catalogue for all PCB prototyped and publicly available here on GitHub AeonLabs, a personal brand of [Miguel T.](https://www.linkedin.com/in/migueltomas/). There are now a total of **36** PCBs for smart devices, A.I. enabled, designed in KiCad and ready to download, fabrication or order on [Tindie](https://www.tindie.com/products/aeonlabs/).
...
you can fill in your [mail here (Google form)](https://docs.google.com/forms/d/e/1FAIpQLScErMgQYRdA-umvCjvTPPrCO7Lg1QYowTxb7vfa8cTfrcPEAA/viewform?usp=pp_url) and I'll send a reminder when it's ready (or if I decide to make a few kits, who knows).
...
*A custom PCB to your needs*

To order a custom PCB acording to your specifications and needs , go [here](https://github.com/aeonSolutions/PCB-Prototyping-Catalogue/tree/main/custom_PCB).
...
- [Home Assistant](https://github.com/aeonSolutions/PCB-Prototyping-Catalogue/tree/main/Home-Automation/README.md)
